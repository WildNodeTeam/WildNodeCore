                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received wildnode from zwld"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zwld"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zwld));
