Contributing to wildnode Core
============================

The wildnode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the wildnode Core project, and is not to be
confused with overall wildnode Network Protocol consensus changes.

Whether a pull request is merged into wildnode Core rests with the project merge
...
Patches that change wildnode consensus rules are considerably more involved than
...
Where a patch set proposes to change the wildnode consensus, it must have been
...
The project leader is the release manager for each wildnode Core release.
