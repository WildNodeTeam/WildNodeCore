...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop wildnode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "wildnode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* wildnode features */
        {"wildnode", "masternode", &masternode, true, true, false},
        {"wildnode", "listmasternodes", &listmasternodes, true, true, false},
        {"wildnode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wildnode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wildnode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wildnode", "masternodedebug", &masternodedebug, true, true, false},
        {"wildnode", "startmasternode", &startmasternode, true, true, false},
        {"wildnode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wildnode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wildnode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wildnode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wildnode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wildnode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wildnode", "mnbudget", &mnbudget, true, true, false},
        {"wildnode", "preparebudget", &preparebudget, true, true, false},
        {"wildnode", "submitbudget", &submitbudget, true, true, false},
        {"wildnode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wildnode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wildnode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wildnode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wildnode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wildnode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wildnode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wildnode", "checkbudgets", &checkbudgets, true, true, false},
        {"wildnode", "mnsync", &mnsync, true, true, false},
        {"wildnode", "spork", &spork, true, true, false},
        {"wildnode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"wildnode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wildnoded, or the -server option to wildnode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> wildnode-cli " + methodname + " " + args + "\n";
}
