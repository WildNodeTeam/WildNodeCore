...
public:
    ...
    void setZwildnodeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzwld_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzwld_clicked();
    void on_pushButtonZwildnodeControl_clicked();
