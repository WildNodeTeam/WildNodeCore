...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("wildnode Core wildnode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wildnode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wildnode transaction") + "\n" +
                               "  wildnode-tx [options] -create [commands]   " + _("Create hex-encoded wildnode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wildnode transaction
