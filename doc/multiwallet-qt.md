...
In order to support loading of multiple wallets in wildnode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wildnode.cpp.
...
Changes to wildnode.cpp
----------------------
wildnode.cpp is the entry point into wildnode-qt, and as such, will require some minor modifications to provide hooks for
