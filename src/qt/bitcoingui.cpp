                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("wildnode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a wildnode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wildnode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zwld"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About wildnode Core"), this);
    aboutAction->setStatusTip(tr("Show information about wildnode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for wildnode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your wildnode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified wildnode addresses"));
    ...
    openAction->setStatusTip(tr("Open a wildnode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the wildnode Core help message to get a list with possible wildnode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("wildnode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to wildnode network", "", count));
}
...
{
    QString strTitle = tr("wildnode Core"); // default title
...
/** Creates context menu, its actions, and wildnodes up all the relevant signals for mouse events. */
