...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("wildnode Core"),
     ...
     * override -datadir in the wildnode.conf file in the default data directory
     * (to be consistent with wildnoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
