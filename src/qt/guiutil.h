...
/** Utility functions used by the wildnode Qt UI.
 */
namespace GUIUtil
{
...
// Render wildnode addresses in monospace font
...
// Parse "wildnode:" URI into recipient object, return true on successful parsing
