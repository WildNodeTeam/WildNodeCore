...
RESOURCES += src/qt/wildnode.qrc src/qt/wildnode_locale.qrc

TRANSLATIONS += src/qt/locale/wildnode_bg.ts \
                src/qt/locale/wildnode_de.ts \
                src/qt/locale/wildnode_en.ts \
                src/qt/locale/wildnode_es.ts \
                src/qt/locale/wildnode_fi.ts \
                src/qt/locale/wildnode_fr.ts \
                src/qt/locale/wildnode_it.ts \
                src/qt/locale/wildnode_ja.ts \
                src/qt/locale/wildnode_pl.ts \
                src/qt/locale/wildnode_pt.ts \
                src/qt/locale/wildnode_ru.ts \
                src/qt/locale/wildnode_sk.ts \
                src/qt/locale/wildnode_sv.ts \
                src/qt/locale/wildnode_vi.ts \
                src/qt/locale/wildnode_zh_CN.ts \
                src/qt/locale/wildnode_zh_TW.ts
